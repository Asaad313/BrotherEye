...
from Vlad.activity import Activity
from Vlad.virtual_assistant import VirtualAssistant
from Vlad.EventDispatcher.event_dispatcher import EventDispatcher
from Vlad.TextManager.text_manager import TextManager
from Vlad.configurer import config
from Vlad.updater import Updater
        ...
        if self.c.config.getboolean("SYSTEM", "wake_up_engine"):
            while not self.active:
                with sr.Microphone() as source:
                    ...
                    if self.active:
                        self.speaker.speak("What can I help you with?")
                        while self.status:
                            with sr.Microphone() as source:
