from Vlad.AudioManager.audio_manager import AudioManager
from Vlad.TextProcessor.text_processor import TextProcessor
from Vlad.TextManager.text_manager import TextManager


class Commander:
    def __init__(self, speech_recognition, recognizer, events):
        self.events = events
        self.audio_manager = AudioManager(recognizer, speech_recognition.UnknownValueError, speech_recognition.RequestError)
