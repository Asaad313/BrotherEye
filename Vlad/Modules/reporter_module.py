...
class ReporterModule(BaseModule):
    ...
    def __init__(self, *args):
        ...
        if self.API_KEY:
            ...
            print("In Modules Reporter Module API Error: Configer the key in config file.")
            return False
        self.sources_url = {}
    ...
    def get_news(self):
        self.assistant.say("Any specific category?")
        ...
        self.assistant.say("Do you have a source preference?")
        ...
        if source_status.upper() in self.NEGATIVE:
            ...
            if category:
                ...
                response = "All sources are as follows:"
                ...
                self.assistant.say("Would you like me to list all the sources, like all 70 of them?")
        ...
        if source:
            ...
            self.assistant.say("And what kind of news sort would you like, latest or maybe top ones shown in front page?")
