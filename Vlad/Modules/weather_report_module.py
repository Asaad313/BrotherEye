...
from Vlad.local_libs.numbers_format import NumberService
...
class WeatherReportModule(BaseModule):
    ...
    def get_weather_report(self, weather, loc, temp_unit='celsius', report='current'):
        ...
        if report == 'current':
            ...
            weather_report = "In " + loc + ". Today is " + stat + ". There is a chance of " \
                             + detstat + ". Temperature is " + curr_temp + " degree " \
            ...
            weather_report = "In " + loc + ". Tomorrow will be " + stat + ". There will be a chance of " \
